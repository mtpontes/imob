...
public class S3Service {
    ...
    @ConfigProperty(name = "quarkus.aws.credentials.static-provider.access-key-id")
    Optional<String> accessKeyId;

    @ConfigProperty(name = "quarkus.aws.credentials.static-provider.secret-access-key")
    ...
    public String generatePutPresignedUrl(String s3Key, Duration expiration) {
