...
public class EvaluationServiceTest {
    ...
    public void shouldCalculateScoreCorrectlyForMixedCriteria() {
        ...
        CriteriaDTO c2 = new CriteriaDTO();
        c2.setId("c2");
        c2.setType("range");
        c2.setScorable(true);
        c2.setWeight(3.0);
        ...
        CriteriaDTO c3 = new CriteriaDTO();
        c3.setId("c3");
        c3.setType("text");
        ...
        script.setCriteria(criteriaList);
        ...
        // Act
        double finalScore = this.evaluationService.calculateFinalScore(script, answers);
    ...
    public void shouldCapRangeScoresToLimits() {
        ...
        // Act
        double scoreUnder = this.evaluationService.calculateFinalScore(script, answersUnderLimit);
        double scoreOver = this.evaluationService.calculateFinalScore(script, answersOverLimit);
